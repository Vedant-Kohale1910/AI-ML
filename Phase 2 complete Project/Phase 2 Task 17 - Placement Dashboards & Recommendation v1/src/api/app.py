...
async def http_exception_handler(request, exc):
    """Handle HTTP exceptions. Must return a Response — returning a bare dict
    makes Starlette try to call it as an ASGI app ('dict' object is not callable),
    which turns every 404/503 into a 500."""
    return JSONResponse(
