...
class FairnessAudit:
    ...
    def detect_bias(self, disparate_impact: float,
                    disparity_percentage: float = None) -> Dict[str, Any]:
        """Classify bias severity from the disparate-impact ratio (the 4/5ths
        rule). disparity_percentage is the raw gap between the best- and
        worst-served groups; it's optional context, surfaced in the result."""
